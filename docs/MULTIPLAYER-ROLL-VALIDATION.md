...
| Reload                                   | Completed chat audit persists; pending Wild/request decisions do not replay                                       | Pass for requested rolls — private/blind audit survived player reload, the open Knowledge prompt did not replay, and GM cancellation cleared the transient task                                              |
