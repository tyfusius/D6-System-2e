...
| Attributes and Skills                                    | `character/attributes.hbs`, `.od6v2-attribute-*`, `.od6v2-skill-*`                      | Canonical cards, scores, actions, and responsive grid; the requested-score outline and highlighter badge are a D62e workflow extension composed from canonical accent tokens |
| Biography                                                | `character/biography.hbs`, `.od6v2-writing-*`                                           | Canonical writing panels with Second Edition labels                                                                                                                          |
| Traits and equipment                                     | `character/inventory.hbs`, `.od6v2-section`, `.od6v2-item-*`                            | Canonical item rows and controls; native feature families are rules-required additions                                                                                       |
...
| Item sheets                                              | `templates/item/v2/*`, `.od6s-item-v2`, `.od6item-*`                                    | Canonical ApplicationV2 shell and fields; feature facts/citations extend the details component                                                                               |
...
| GM Quickbar (legacy internal `pc-quickbar` identifiers)  | `templates/apps/pc-quickbar.hbs`, `.od6-pc-quickbar`, `.od6pc-*`                        | Exact component and Token Controls toolbar contract; visible name covers PCs, NPCs, and creatures; pending highlighted requests use the same D62e requested-score marker     |
