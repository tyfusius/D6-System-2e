...
`Compendium.d6-system-2e.open-d6-skills` namespace are rewritten to
`Compendium.open-d6-core-content-d6-system-2e.open-d6-skills`. Pack and
document IDs remain unchanged, and repeated migration is idempotent.
...
| 39      | Edition-aware Template provenance             | Adds the selected rules edition to applied Template provenance without changing existing application records                                                                                 |
| 40      | Template container contracts                  | Adds loss-preserving typed containers needed by specialized Template imports while retaining unknown source data                                                                             |
| 41      | First Edition genre Attributes                | Adds the resolved First Edition genre Attribute profile without coercing Second Edition or unknown Attribute data                                                                            |
| 42      | First Edition Fantasy mechanics               | Adds persistent Fantasy Magic and Strength-damage state while preserving inactive and cross-edition data                                                                                     |
| 43      | Companion profile fields                      | Adds companion-neutral character allegiance/currency and Starship interstellar-drive fields without selecting companion presentation                                                         |
