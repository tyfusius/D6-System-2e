...
| First Edition resistance, wounds, and healing | D6S pp. 75-76, 79               | implemented            | Independent schema-17 wound track; Strength/Brawn plus armor resistance; damage-minus-resistance thresholds; distinct Severely Wounded state; repeated/lower-damage progression; action penalties; GM-only targeted application and chat audit. Wound Level natural healing, assisted Medicine difficulties, and elapsed-minute Mortally Wounded checks use the shared roll pipeline without action/wound penalties. Optional Body Points rescue, stun-only damage, and machine damage remain later slices. |
...
| Staggered/Stunned/Wounded progression         | D62e pp. 33-34                  | implemented            | Brawn greater than Damage causes Staggered; a second Staggered while already Staggered causes Stunned, including the Hero Point prevention choice. Repeated Wounded progresses through Incapacitated to Mortally Wounded. The original Damage card retains the applied audit and blocks normal duplicate application                                                                                                                                                                                        |
