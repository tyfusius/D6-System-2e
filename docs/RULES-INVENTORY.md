...
| Movement and prone                          | D62e p. 32                      | implemented            | Typed declaration modes, run/crawl penalties, finish-prone choice, posture transitions on action completion, prone defenses, and standing action; automatic token movement remains deferred                                                                                                                                                       |
