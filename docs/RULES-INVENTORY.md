...
| Damage and mortal-wound trigger             | D62e p. 33                      | ruling accepted        | Brawn equal to or below Damage causes Wounded; if the Brawn resistance roll invokes a Complication, it instead causes Mortally Wounded. The contrary Damage-roll wording is treated as a typo; see `RULES-RULINGS.md`                                             |
| Staggered/Stunned/Wounded progression       | D62e pp. 33-34                  | ruling accepted        | Brawn greater than Damage causes Staggered; a second Staggered result while already Staggered causes Stunned. The contrary direct-Stunned example is treated as a typo; see `RULES-RULINGS.md`                                                                    |
...
| Scale                                       | D62e pp. 196-197                | implemented foundation | Persistent ranks and typed scene-relative Attack, ranged Dodge, Damage, and Brawn-resistance modifiers with dialog/chat audit; damage comparison remains separately blocked                                                                                       |
