...
| Typed roll pipeline            | Attribute, skill, item, damage, resistance, reaction, and request rolls share a system service                       | **Partial:** attribute, skill, targeted weapon attack, raw weapon damage, Brawn-plus-armor resistance, Hero Point reroll, and Doubling Down share one service; reaction and damage comparison remain                                            |
...
| Conditions and damage          | Derived resistance, condition lifecycle, and authoritative application services                                      | **Partial:** resistance derives Brawn plus the strongest body armor and strongest shield without action/wound penalties; a persistent manual condition track exists; damage comparison/application remains blocked by the page 33 contradiction |
