...
| Typed roll pipeline            | Attribute, skill, item, damage, resistance, reaction, and request rolls share a system service                       | **Partial:** attribute/skill, difficulty, and opposed calls share one service; advanced workflows remain                                         |
| Wild Die and resource spending | Typed policies and result records drive chat and integrations                                                        | **Partial:** both Wild Die policies, 2e awards, and Die Code doubling work; rerolls remain                                                       |
...
| Migrations                     | Ordered, idempotent transforms with per-document metadata                                                            | **Implemented foundation:** schema 5 preserves latent First Edition resources and admits typed cross-edition Items                               |
| Public API                     | Version negotiation, read models, rolls, registries, combat services                                                 | **Partial:** Actor read model, basic rolls, and registries are live; combat remains                                                              |
...
| Settings architecture          | Shared settings plus grouped rules, creation, automation, and presentation options                                   | **Foundation implemented:** shared root options and dedicated First/Second Edition ApplicationV2 menus; further settings require typed consumers |
