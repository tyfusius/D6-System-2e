...
The current pass adds the OpenD6 Next-style Combat tab structure, profile-aware
Skill provisioning, public compendium packaging, expanded compatibility document
families, and the shared Item attack/damage entry point. It does not claim parity
for OpenD6 Next's action scheduler, active defenses, damage application,
...
| Public API                     | Version negotiation, read models, rolls, registries, combat services                                                 | **Partial:** Actor read model, registries, and attribute/skill/item rolls are live; authoritative combat mutation services remain                |
