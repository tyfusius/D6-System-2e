...
| Migrations                     | Ordered, idempotent transforms with per-document metadata                                                            | **Implemented foundation:** schema 10 preserves cross-edition resources, machine Actor state, creature overrides, and unknown imported data                                                                                                  |
...
| Dice So Nice                   | Optional presentation integration                                                                                    | **Implemented foundation:** optional distinct `dw` term and OpenD6 Classic Wild Die preset; companion-contributed profiles remain later work                                                                                                 |
