...
const template = (id, label, page, scores, suggestedSkillKeys) => ({
...
const gear = (name, price, page = 114) => ({
  era: "medieval",
  id: slug(name),
  kind: "gear",
  name,
...
const equipment = [
  ...
  ...[
    ...
    weapon(name, score, 118, undefined, "melee-combat", "strength-damage"),
  ),
];

const manifestation = (name, skill, difficulty, page, tradition = "magic") => ({
...
const manifestations = [
  ...[
    ...
    ["Divination", 11, 102],
    ["Divination", 25, 102],
  ].map(([skill, difficulty, page], index) =>
    manifestation(
...
const vehicles = [
  vehicle("chariot", "Chariot", 3, 12, -2, 2, 1, "animal Move × 75%"),
  vehicle("wagon", "Wagon", 5, 13, 0, 8, 1, "animal Move × 50%"),
  vehicle(
    "passenger-carriage",
    "Passenger Carriage",
    6,
  ...
  vehicle("mine-cart", "Mine Cart", 3, 16, -9, 2, 1, "animal Move × 25%"),
...
const shipWeapon = (name, damage, range, attackBonus = 0) => ({
  id: slug(name),
  name,
  system: {
...
const ancestryFeature = (species, name, type, rank, cost, mechanic) => ({
...
const ancestryFeatures = [
  ...
  ancestryFeature(
    ...
    3,
    0,
    "+1 difficulty per round below 15°C.",
  ),
  ancestryFeature(
    "Reptile Folk",
    "Social Difficulty",
...
const ancestry = (name, scale, moveModifier) => ({
  id: `${slug(name)}-ancestry`,
  label: `${name} Ancestry`,
  memberIds: ancestryFeatures
