...
export class GearDataModel extends foundry.abstract.TypeDataModel {
  static defineSchema(): Record<string, object> {
    return {
      ...
      medicalConsumable: new SchemaField({
        version: new NumberField({
          initial: 1,
          integer: true,
          min: 1,
        ...
        effectId: new StringField({
          initial: "tyfusius.model-b-wound-penalty-suppression",
          nullable: false,
          required: true,
        }),
        ...
        treatmentFamily: new StringField({
          choices: ["none"],
          initial: "none",
          nullable: false,
          required: true,
...
export class WeaponDataModel extends foundry.abstract.TypeDataModel {
  static defineSchema(): Record<string, object> {
    return {
      ...
      autofireRating: new NumberField({
        initial: 0,
        integer: true,
        min: 0,
        nullable: false,
