...
export const SECOND_EDITION_OPTION_KEYS = Object.freeze({
  ...
  cyberpunkModule: "secondEditionCyberpunkModule",
...
export const SECOND_EDITION_SETTINGS = Object.freeze([
  ...
  secondEdition(
    ...
    {
      choices: {
        none: "D6E2.Settings.SecondEdition.SuperheroicDieCodeCap.None",
        young: "D6E2.Settings.SecondEdition.SuperheroicDieCodeCap.Young",
        street: "D6E2.Settings.SecondEdition.SuperheroicDieCodeCap.Street",
        standard: "D6E2.Settings.SecondEdition.SuperheroicDieCodeCap.Standard",
        national: "D6E2.Settings.SecondEdition.SuperheroicDieCodeCap.National",
        worldwide:
          "D6E2.Settings.SecondEdition.SuperheroicDieCodeCap.Worldwide",
        cosmic: "D6E2.Settings.SecondEdition.SuperheroicDieCodeCap.Cosmic",
      },
    },
  ),
  secondEdition(
...
export const SECOND_EDITION_SETTING_GROUPS = Object.freeze([
  ...
  {
    hint: "D6E2.Settings.SecondEdition.Groups.Superheroes.Hint",
