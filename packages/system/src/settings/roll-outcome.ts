...
export type D6RetryRuntimeStrategyId =
  "d6e2.retries.doubling-down" | "open-d6.retries.no-general-reroll";

export interface D6RetryRuntimeStrategy {
  readonly followUp: "doubling-down" | "none";
