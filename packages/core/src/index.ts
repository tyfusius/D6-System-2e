...
export type {
  D6HealthDamageBandV3,
  D6HealthDamageOutcomeId,
  D6HealthDamageResultRuleV3,
...
} from "./domain/health-model-authoring";
export type {
  D6HealthSimulationInputV1,
  D6HealthSimulationResultV1,
  D6HealthTransitionDiffV1,
} from "./domain/health-model-authoring";
export {
...
export type {
  ...
  D6ScaleRollContext,
  D6SecondEditionAutofireRollContext,
  D6RollKind,
  D6HeroPointUse,
