...
async function archiveText(archive, entry) {
  return (await execFileAsync("unzip", ["-p", archive, entry])).stdout;
}
...
console.info(
  `Verified ${releasePackages.length} reproducible archives, clean installs, and representative alpha.32 upgrades for ${system.version}.`,
);
